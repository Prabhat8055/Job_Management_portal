...
const OAuthFailure = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-gradient-to-br from-slate-100 via-white to-slate-200 px-4 dark:from-[#060816] dark:via-[#0B0F19] dark:to-[#111827]">
